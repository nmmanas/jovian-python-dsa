...
class Solution:
    ...
    Question:
    Write a program to get the count of connected components

    Constraints:
    N/A

    Problem statement (Step 1):
    Given a graph with number of nodes and list of edges, find how many sub-graphs
    are available which are only connected to themselves
...
def load_test_cases():
    ...
    1. all nodes are connected - one connected component
    2. multiple connected components
    3. individual nodes, without edges
    4. no nodes
    """
    test_cases = []
